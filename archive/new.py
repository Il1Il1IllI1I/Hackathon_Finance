...
s_df = pd.read_csv('date_before.csv')
formatted_kospi_corrected_df = pd.read_csv('formatted_kospi_data_corrected.csv')
...
investing_df = investing_df[['base_date', 'm_return', 'kospi', 'before_last']]
